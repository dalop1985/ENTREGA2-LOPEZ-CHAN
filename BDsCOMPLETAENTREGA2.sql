...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla que servirá de enlace para validar la ubicación del Empleado dentro de la organización.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla que nos dará la información de las ciudades o pueblos a los que puede pertenecer la persona';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `princiudades` VALUES (1,'Tulum','Quintana Roo','México'),(3,'Cancún','Quintana Roo','México'),(4,'Chetumal','Quintana Roo','México'),(5,'Ticul','Yucatán','México'),(6,'Mérida','Yucatán','México'),(7,'Progreso','Yucatán','México'),(8,'Valladolid','Yucatán','México'),(9,'Izamal','Yucatán','México'),(10,'Oxcutzcab','Yucatán','México'),(11,'CDMX','CDMX','MÉXICO');
